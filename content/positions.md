...
Positions are a fundamental element of partner dance. Salsa dance elements include the following:
...
#### What is a position
A salsa dance position comprises the orientation of the dancers with respect to each other and the handhold.

> [Link to handholds blog article](https://salsahandbook.github.io/output/salsa-handholds.html)

Aspects of dancer orientation include what direction each dancer is facing, at what level are the hands held, and the direction of eye gaze.


#### Why is the dance position important
Every salsa dance pattern begins and ends in a dance position. One can view salsa dance as the artful transition through a series of positions. Expert salsa dancers know how to get into and out of myriad salsa dance positions in interesting ways. Knowing how to do this can help increase your salsa dance repertoire.  This is facilitated by knowing your dance positions.


#### How does the position fit into patterns and combinations
A salsa dance combination is comprised of two or more salsa dance patterns, each pattern covering two bars of music. Every salsa dance pattern begins and ends in a dance position. The salsa dance pattern is a transition from a start position to an end position over eight beats of music. Because salsa dance is made up of combinations, and combinations are made up of patterns, one can view salsa dance as an aesthetically pleasing progression through a series of dance positions over the course of a song. 



We refer to the leader as Leader.  We refer to the follower as Follower.
...
- FEO, LRH on Follower left upper back, FLH on LLS.
...
The most common position is Open Position.  It is actually just one kind of open position. An open position is any position involving a handhold that is not a closed position.  However, because this is by far the most common open position, and because the other open positions all tend to have their own distinctive name, this position is usually called just "Open Position". 
...
<p><div style="text-align:center"><img src="images/Positions/Half_Open_R_to_L_LLHS.PNG" width="150" height="262" /></div></p>
...
<p><div style="text-align:center"><img src="images/Positions/Half_Open_L_to_R_LLHS.PNG" width="150" height="262" /></div></p>
...
<p><div style="text-align:center"><img src="images/Positions/Handshake_LLHS.PNG" width="150" height="262" /></div></p>
...
<p><div style="text-align:center"><img src="images/Positions/Reverse_Handshake_LLHS.PNG" width="150" height="262" /></div></p>
...
<p><div style="text-align:center"><img src="images/Positions/Crosshold_LLHS.PNG" width="150" height="262" /></div></p>
...
<p><div style="text-align:center"><img src="images/Positions/fsd_lib_reverse_parallel_hold_high.png" width="150" height="262" /></div></p>
...
<p><div style="text-align:center"><img src="images/Positions/Butterfly_FSD_LIB_High.PNG" width="150" height="262" /></div></p>
...
<p><div style="text-align:center"><img src="images/Positions/Half_L_Butterfly__Half_R_Self_Neck_Loop_LOW.PNG" width="150" height="262" /></div></p>
