...
For the new illustrations I am using stylized characters to model the dance poses.  I have narrowed it down to four `Leader` models and three `Follower` models, along with nine different `Follower` wardrobes and five different `Leader` wardrobes. Nine pairings of these model and wardrobe combinations are shown below.
