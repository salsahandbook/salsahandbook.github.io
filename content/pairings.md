...
I am using stylized characters for models to demonstrate the dance poses: four `Leader` models and three `Follower` models, dressed with nine different `Follower` wardrobes and five different `Leader` wardrobes. Nine pairings of these model and wardrobe combinations are shown below. **Please share your vote!**  We value your opinion.
