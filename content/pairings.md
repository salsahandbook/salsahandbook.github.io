Title: Help me choose my illustration models
...
Summary: This article asks the reader to vote on their favorite dance couple from a list of digital models.



# PICK YOUR FAVORITE ILLUSTRATION MODEL

Dear reader. 

I have a favor to ask of you. I am redoing all of the illustrations in my books. I am about to re-render all of the illustrations with new models.  Could you kindly take a moment and tell me your favorite models by tweeting me at **@salsahandbook**?  Your feedback would be appreciated very much.


For the new illustrations I am using stylized characters to model the dance poses.  I have narrowed it down to four `Leader` models and three `Follower` models, along with eight different `Follower` wardrobes and five different `Leader` wardrobes. Nine pairings of these model and wardrobe combinations are shown below.


**Please express your preference!**  

Just scroll down to see the choices.
...
# Pairing 1:
<p><div style="text-align:left"><img src="images/pairings/1_front_left.png" width="375" height="655" /></div></p>

# Pairing 2:

<p><div style="text-align:left"><img src="images/pairings/2_front_left.png" width="375" height="655" /></div></p>


# Pairing 3:

<p><div style="text-align:left"><img src="images/pairings/3_front_left.png" width="375" height="655" /></div></p>


# Pairing 4:

<p><div style="text-align:left"><img src="images/pairings/4_front_left.png" width="375" height="655" /></div></p>

# Pairing 5:

<p><div style="text-align:left"><img src="images/pairings/5_front_left.png" width="375" height="655" /></div></p>

# Pairing 6:

<p><div style="text-align:left"><img src="images/pairings/6_front_left.png" width="375" height="655" /></div></p>

# Pairing 7:

<p><div style="text-align:left"><img src="images/pairings/7_front_left.png" width="375" height="655" /></div></p>

# Pairing 8:

<p><div style="text-align:left"><img src="images/pairings/8_front_left.png" width="375" height="655" /></div></p>

# Pairing 9:

<p><div style="text-align:left"><img src="images/pairings/8a_front_left.png" width="375" height="655" /></div></p>
...
I've published several reference books about salsa dance. Links are provided below in the More Reading section. 
